...
//        Function<Integer, Integer> timesTwoMinusOne = timesTwo.compose(minusOne); // reverse order, first minusOne then timesTwo
        Function<Integer, Integer> timesTwoMinusOne = minusOne.andThen(timesTwo); // more readable and we can know the order
