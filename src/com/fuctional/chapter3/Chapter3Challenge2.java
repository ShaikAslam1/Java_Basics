...
public class Chapter3Challenge2 {
    ...
    public static void main(String[] args) {
        ...
        Long totalDevelopers = employees.stream()
                .filter(employee -> employee.jobTitle.equals("developer"))
                .collect(Collectors.counting());

        float avgSalary = totalSalary / totalDevelopers;
        System.out.println(avgSalary);

        // answer
        Map<String, Float> avgSalariesMap = employees.stream().collect(Collectors.groupingBy(employee -> employee.jobTitle))
                .entrySet()
                .stream()
        ...
        System.out.println(avgSalariesMap);
    }
}
